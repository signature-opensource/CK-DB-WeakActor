...
namespace CK.DB.Actor.WeakActor
{
    ...
    public abstract class WeakActorTable : SqlTable
    {
        /// <summary>
        /// Creates a WeakActor.
        /// </summary>
        ...
        public abstract Task AddWeakActorIntoGroupAsync( ISqlCallContext c, int actorId, int groupId, int weakActorId );
    }
}
